<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="MY_Service.Pages.Home" %>
...
<body>
   <div  id="div_loader" style="width:100%;text-align:center;height:95vh;background-color:#1e5e66">
         <h1 style="font-size:80px;color:lightgray;padding-top:20%">We goes Online in<br />00:00:<span id="countdowntimer">3 </span></h1>
        </div>
    <div id="xyz">
   <div class="loader" style="background-color:#0c0c0c"></div>
        ...
        <div class="container-fluid" style="background-color: lightgray;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right" style="font-size: 18px; padding-top: 15px;">
                    <li><a href="Registration.aspx" target="_blank">Register<span class="sr-only">(current)</span></a></li>
                    <li><a href="LogIn.aspx">Log In</a></li>
                    <li><a href="FeedBack.aspx" target="_blank">Add Review</a></li>
                    <li><a href="How It Works.aspx" target="_blank">How It Works</a></li>
                    <li><a href="AboutUs.aspx" target="_blank">About Us</a></li>
                </ul>
            </div>
        </div>
        <div id="amazingslider-wrapper-1" style="display: block; position: relative; max-width: 100%; top: 0">
                    ...
                    <span style="display: inline-block; list-style: none;">
                        <asp:LinkButton ID="lb_catName" runat="server" ForeColor="Black" Font-Bold="true" OnClick="categoryName_Click" Font-Underline="false">
                            <li>
                                ...
                                <asp:Image alt="categoryImage" CssClass="zoomin img" ID="categoryImage" runat="server" ImageUrl='<%# "~/Images/Category/"+System.Convert.ToString(Eval("Image")) %>' />
                            </li>
                            <li>
                                <%#Eval("Name") %>
                            </li>
    ...
    <div id="subCatDiv" class="w3-modal w3-animate-zoom">
        <div class="w3-modal-content" style="overflow-x: auto;overflow-y:auto">
            <header class="w3-teal" style="margin-bottom:5px;">
                <b class="headBar">Select Your Service</b>
            </header>
                    ...
                    <ItemTemplate>
                        <span style="list-style: none;">
                            <li style="height: 40px; padding: 0 0 20px 20px">
                                <asp:Image alt="categoryImage" Style="height: 30px; width: 30px;" ID="subCategoryImage" runat="server" ImageUrl='<%# "~/Images/subCategory/"+System.Convert.ToString(Eval("Image")) %>' />
                                <a class="SubCatName" href="workInUnderProcess.aspx" target="_blank"><%#Eval("Name") %></a>
                            </li>
                        </span>
                    </ItemTemplate>
                </asp:Repeater>
